...
Message.create(conversation_id: 1, user_id: 2, body: "b's reply is the 2nd message in this thread", created_at: '2019-08-11 04:12:45', updated_at: '2019-08-11 04:12:45')
ConversationUser.create(conversation_id: 1, user_id: 2)
ConversationUser.create(conversation_id: 1, user_id: 1)

Conversation.create(user_id: 2, subject: "this is b's message thread", created_at: '2019-08-06 01:04:44', updated_at: '2019-08-06 01:04:44')
Message.create(conversation_id: 2, user_id: 2, body: "b's 1st message", created_at: '2019-08-06 01:04:44', updated_at: '2019-08-06 01:04:44')
